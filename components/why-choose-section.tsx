      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-1/2">
            <div className="rounded-full overflow-hidden aspect-square bg-[#E2E3E1] max-w-lg mx-auto flex items-center justify-center shadow-2xl shadow-black/35">
              <Image
          ...
          <div className="w-full lg:w-1/2 space-y-6">
            ...
            <p className="text-lg text-gray-600">
              SmartPlate adapts to your unique needs, whether you're managing a
              health condition, following a specific diet, or simply wanting to
              eat healthier.
            </p>
